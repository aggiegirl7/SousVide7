...
public class DisplayCook extends AppCompatActivity {
    ...
    /*public void onClick(View v) {
        switch (v.getId()) {
            case R.id.checkCon:
                ...
                if (isConnectedTo("0c17da", DisplayCook.this)) {
                    Toast.makeText(DisplayCook.this, "\n Class: \t " + "You're still connected!", Toast.LENGTH_LONG).show();
    ...
    private void notification() {
        ...
        //Toast.makeText(DisplayCook.this, "Notification()", Toast.LENGTH_LONG).show();
    }
    ...
    private void notification2() {
        ...
        NotificationManager notifyMgr = (NotificationManager)
                getSystemService(NOTIFICATION_SERVICE);
        notifyMgr.notify(notificationID, builder.build());
        // Toast.makeText(DisplayCook.this, "Notification2()", Toast.LENGTH_LONG).show();
    }
    // under value
    private void notification3() {
        ...
        NotificationManager notifyMgr = (NotificationManager)
                getSystemService(NOTIFICATION_SERVICE);
        notifyMgr.notify(notificationID, builder.build());
        //Toast.makeText(DisplayCook.this, "Notification3()", Toast.LENGTH_LONG).show();
    }
    //Preheat Done
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //String str = example.getStringExtra("message");
        ...
        Intent example = getIntent();
        String temp = example.getStringExtra("message");
        ...
        int ManualTimevar = intent.getIntExtra(ManualCook.EXTRA_NUMBER,0);
        int ManualTempvar = intent.getIntExtra(ManualCook.EXTRA_TEXT,0);


        TextView textView3 = (TextView) findViewById(R.id.Timedisp);
        TextView textView4 = (TextView) findViewById(R.id.Tempdisp);
        ...
        textView3.setText("" + ManualTimevar + " hour(s)" );
        textView4.setText("" + ManualTempvar + "\u2109");
        //test = ManualTimevar*60*60000;
        test = 1*60000;

        START_TIME_IN_MILLIS = Long.parseLong(String.valueOf(test));
        Toast.makeText(DisplayCook.this, "Mantempvar " + START_TIME_IN_MILLIS, Toast.LENGTH_LONG).show();
...
*/
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (value2 == 1) {
                            ...
                            Toast.makeText(DisplayCook.this, "" + value2.toString(), Toast.LENGTH_LONG).show();
                            AlertDialog.Builder builder = new AlertDialog.Builder(DisplayCook.this);
        ...
        reference1.child("data")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot2) {
                        ...
                        int x = Integer.valueOf(ManualTempvar ) - 30;
                        int y = Integer.valueOf(ManualTempvar )+ 30;
                        AlertDialog.Builder builder3 = new AlertDialog.Builder(DisplayCook.this);

                   // if((value > Integer.valueOf((ManualTempvar))-5) && (Preheat == 0))
                        //    {Preheat = 1;}
                        if((value > Integer.valueOf((ManualTempvar))-3) && (Preheat == 1)) {
                            imgRes = R.drawable.check;
                        }

                       if((value > Integer.valueOf((ManualTempvar))-3) && (Preheat == 0)){
                            imgRes = R.drawable.check;
                            ...
                            Toast.makeText(DisplayCook.this, "" + Preheat, Toast.LENGTH_LONG).show();
                        ...
                        else if (value < Integer.valueOf(ManualTempvar)) {
                            imgRes = R.drawable.x;
                        }
                        ...
                        if (value > Integer.valueOf(ManualTempvar)-5 && firstGood == 0)
                        {firstGood = 1;

                            Toast.makeText(DisplayCook.this, "first good" + firstGood, Toast.LENGTH_LONG).show();
                        }
                            ...
                            Toast.makeText(DisplayCook.this, "" + value.toString(), Toast.LENGTH_LONG).show();
                            AlertDialog.Builder builder = new AlertDialog.Builder(DisplayCook.this);
                            AlertDialog.Builder builder5 = new AlertDialog.Builder(DisplayCook.this);
                            if (value >Integer.valueOf(ManualTempvar)+30)
                            {
                                notification2();
                                builder.setCancelable(true);
                                builder.setTitle("Warning!");
                            ...
                            if(value >Integer.valueOf(ManualTempvar)-5){
                                Preheat = 1;
                                Toast.makeText(DisplayCook.this, "Preheat" + Preheat, Toast.LENGTH_LONG).show();
                            }

                            if((value<Integer.valueOf(ManualTempvar)-30) && Preheat ==1)
    ...
    public void startTimer() {
        ...
        mCountDownTimer = new CountDownTimer(mTimeLeftInMillis, 1000) {
            ...
            public void onFinish() {
                mTimerRunning = false;
                Toast.makeText(DisplayCook.this, "Finished!", Toast.LENGTH_SHORT).show();
                updateButtons();
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        ...
                        Toast.makeText(DisplayCook.this, "Fail to add data " + error, Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void updateCountDownText() {
        Toast.makeText(DisplayCook.this, "timefirst" + timeFirst, Toast.LENGTH_LONG).show();
        if (timeFirst == 0)
        {
            mTimeLeftInMillis = START_TIME_IN_MILLIS;
